...
def job_params
  params.require(:job).permit(:title,:description,:is_admin, :wage_upper_bound, :wage_lower_bound, :contact_email, :is_hidden, :require_skill, :company, :address, :many_kind)
end
